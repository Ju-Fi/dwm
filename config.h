...
static const char *fonts[]          = { "CaskaydiaCove Nerd Font:size=12", "Font Awesome 5 Free Regular:size=15", "Font Awesome 5 Free Solid:size=12" };
...
//Top bar second color (blue default) and active window border color
...
/* tagging */
static const char *tags[] = { "А", "Б", "В", "Г", "Д", "Е", "Ё", "Ж", "З" };
